...
const shareText = "Help us understand how people find everyday help.";
...
export function ThankYouPage() {
  ...
  async function shareSurvey() {
    ...
    const payload = { title: "Tebnu", text: shareText, url };
    ...
    <div className="survey-shell">
      <div className="relative mx-auto flex min-h-svh w-full max-w-xl flex-col items-center justify-center px-6 py-10 lg:max-w-7xl lg:px-10">
        <div className="grid w-full items-center lg:grid-cols-2 lg:gap-10">
          ...
          <SuccessIllustration />
          <h1 className="mt-6 text-4xl font-extrabold text-white">Thank you!</h1>
          <p className="mx-auto mt-4 max-w-md text-[16px] leading-relaxed text-[#D9D2EC]">
            Your answers help us understand how people actually find and choose everyday help.
          </p>
